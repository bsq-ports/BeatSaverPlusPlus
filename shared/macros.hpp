...
#define DECLARE_SIMPLE_RESPONSE_T(namespace_, type_)                            \
...
#define RAPIDJSON_TYPEHELPER(type_)                                                                                                                                 \
...
RAPIDJSON_TYPEHELPER(namespace_::name_)

#define GETTER_FIELD(type_, name_, key_)                                                                                            \
private:                                                                                                                            \
    type_ __##name_;                                                                                                                \
...
#define GETTER_FIELD_DEFAULT(type_, name_, default_, key_)                                                                          \
private:                                                                                                                            \
...
#define GETTER_FIELD_OPTIONAL(type_, name_, key_)                                                                                   \
private:                                                                                                                            \
...
#define RESPONSE_STRUCT(namespace_, name_, __VA_ARGS__) \
SERDE_STRUCT(namespace_, name_, __VA_ARGS__);           \
namespace namespace_ {                                  \
    DECLARE_SIMPLE_RESPONSE_T(namespace_, name_);       \
}                                                       \
